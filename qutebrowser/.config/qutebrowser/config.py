...
c.bindings.key_mappings["<Ctrl-х>"] = "<Ctrl-[>"
c.bindings.key_mappings["<Ctrl-й>"] = "<Ctrl-q>"
c.bindings.key_mappings["<Ctrl-ц>"] = "<Ctrl-w>"
c.bindings.key_mappings["<Ctrl-а>"] = "<Ctrl-f>"
c.bindings.key_mappings["<Ctrl-з>"] = "<Ctrl-p>"
c.bindings.key_mappings["<Ctrl-и>"] = "<Ctrl-b>"
c.bindings.key_mappings["<Ctrl-ж>"] = "<Ctrl-:>"
c.bindings.key_mappings["<Ctrl-ф>"] = "<Ctrl-a>"
c.bindings.key_mappings["<Ctrl-к>"] = "<Ctrl-r>"
c.bindings.key_mappings["<Ctrl-ы>"] = "<Ctrl-s>"
c.bindings.key_mappings["<Ctrl-е>"] = "<Ctrl-t>"
c.bindings.key_mappings["<Ctrl-п>"] = "<Ctrl-g>"
c.bindings.key_mappings["<Ctrl-9>"] = "<Ctrl-(>"
c.bindings.key_mappings["<Ctrl-я>"] = "<Ctrl-z>"
c.bindings.key_mappings["<Ctrl-ч>"] = "<Ctrl-x>"
c.bindings.key_mappings["<Ctrl-с>"] = "<Ctrl-c>"
c.bindings.key_mappings["<Ctrl-в>"] = "<Ctrl-d>"
c.bindings.key_mappings["<Ctrl-м>"] = "<Ctrl-v>"
c.bindings.key_mappings["<Ctrl-о>"] = "<Ctrl-j>"
c.bindings.key_mappings["<Ctrl-д>"] = "<Ctrl-l>"
c.bindings.key_mappings["<Ctrl-г>"] = "<Ctrl-u>"
c.bindings.key_mappings["<Ctrl-н>"] = "<Ctrl-y>"
c.bindings.key_mappings["<Ctrl-э>"] = "<Ctrl-'>"
c.bindings.key_mappings["<Ctrl-ъ>"] = "<Ctrl-]>"
c.bindings.key_mappings["<Ctrl-ь>"] = "<Ctrl-m>"
c.bindings.key_mappings["<Ctrl-т>"] = "<Ctrl-n>"
c.bindings.key_mappings["<Ctrl-у>"] = "<Ctrl-e>"
c.bindings.key_mappings["<Ctrl-ш>"] = "<Ctrl-i>"
c.bindings.key_mappings["<Ctrl-щ>"] = "<Ctrl-o>"
c.bindings.key_mappings["<Ctrl-ж>"] = "<Ctrl-;>"
c.bindings.key_mappings["<Ctrl-л>"] = "<Ctrl-k>"
c.bindings.key_mappings["<Ctrl-р>"] = "<Ctrl-h>"
c.bindings.key_mappings["<Ctrl-б>"] = "<Ctrl-,>"
c.bindings.key_mappings["<Ctrl-ю>"] = "<Ctrl-.>"
c.bindings.key_mappings["<Ctrl-.>"] = "<Ctrl-/>"
c.bindings.key_mappings["<Ctrl-0>"] = "<Ctrl-)>"
