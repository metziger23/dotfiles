...
return {
	...
	keys = {
	   ...
	   -- { "<BS>f", function() require("snacks").picker.smart() end, desc = "Smart", mode = { "n", "x" }  },
	   -- { "<BS>gb", function() require("snacks").picker.git_branches() end, desc = "Git Branches", mode = { "n", "x" }  },
	   { "<BS>gr", function() require("snacks").picker.git_branches() end, desc = "Git Branches", mode = { "n", "x" }  },
	   ...
	   { "<BS>zc", function() zoxide_picker(require("snacks").picker.actions.cd) end, desc = "Zoxide cd", mode = { "n", "x" }, },
