	...
	config = function()
      ...
      log_templates = {
        default = {
          ...
          -- }
          javascript = [[console.info("%tag %log_target", %log_target)]],
          typescript = [[console.info("%tag %log_target", %log_target)]],
          astro =      [[console.info("%tag %log_target", %log_target)]],
          vue =        [[console.info("%tag %log_target", %log_target)]],
          jsx =        [[console.info("%tag %log_target", %log_target)]],
          tsx =        [[console.info("%tag %log_target", %log_target)]],
          ...
          cpp =        [[qInfo() << "%tag %log_target: " << %log_target;]],
          ...
          qml =        [[console.info("%tag %log_target", %log_target)]],
          qmljs =      [[console.info("%tag %log_target", %log_target)]],
        },
        plain = {
          javascript = [[console.info("%tag %insert_cursor")]],
          typescript = [[console.info("%tag %insert_cursor")]],
          astro =      [[console.info("%tag %insert_cursor")]],
          vue =        [[console.info("%tag %insert_cursor")]],
          jsx =        [[console.info("%tag %insert_cursor")]],
          tsx =        [[console.info("%tag %insert_cursor")]],
          ...
          qml =        [[console.info("%tag %insert_cursor")]],
          qmljs =      [[console.info("%tag %insert_cursor")]],
        },
        line_text = {
          javascript = [[console.info("%tag %line_text")]],
          typescript = [[console.info("%tag %line_text")]],
          astro =      [[console.info("%tag %line_text")]],
          vue =        [[console.info("%tag %line_text")]],
          jsx =        [[console.info("%tag %line_text")]],
          tsx =        [[console.info("%tag %line_text")]],
          ...
          qml =        [[console.info("%tag %line_text")]],
          qmljs =      [[console.info("%tag %line_text")]],
        }
      },
      batch_log_templates = {
        default = {
          javascript = [[console.info({ %repeat<"%tag %log_target": %log_target><, > })]],
          typescript = [[console.info({ %repeat<"%tag %log_target": %log_target><, > })]],
          astro =      [[console.info({ %repeat<"%tag %log_target": %log_target><, > })]],
          vue =        [[console.info({ %repeat<"%tag %log_target": %log_target><, > })]],
          jsx =        [[console.info({ %repeat<"%tag %log_target": %log_target><, > })]],
          tsx =        [[console.info({ %repeat<"%tag %log_target": %log_target><, > })]],
          ...
          cpp =        [[qInfo() %repeat<<< "%tag %log_target: " << %log_target>< << "\n  " >;]],
          ...
          qml =        [[console.info({ %repeat<"%tag %log_target": %log_target><, > })]],
          qmljs =      [[console.info({ %repeat<"%tag %log_target": %log_target><, > })]],
        },
      },
			-- stylua: ignore end
