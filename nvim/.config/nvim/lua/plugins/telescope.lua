return {
    ...
    { "<leader>fG", function() require("telescope.builtin").live_grep({ additional_args = { "--hidden" }}) end, desc = "Live Grep (Including Hidden)" },
		...
		{ "<leader>fW", function() require("telescope.builtin").grep_string({ additional_args = { "--hidden" }}) end, desc = "Find Word Under Cursor (Including Hidden)" },
